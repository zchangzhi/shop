...
import com.hngy.utils.SystemContext;
import com.hngy.utils.UUIDUtils;
...
public class ItemController extends BaseController {
    ...
    private void itemCommon(Item item, @RequestParam("file") CommonsMultipartFile[] files, HttpServletRequest request) throws IOException {
        if(files.length>0&&files[0].getOriginalFilename().length()>0) {
           ...
           // System.out.println("字符串长度为"+files[0].getOriginalFilename().length()+"sadadadadasdasdasdadadsadasdada");
        }
