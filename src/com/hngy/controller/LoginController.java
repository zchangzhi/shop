...
import com.hngy.base.BaseController;
import com.hngy.po.*;
...
public class LoginController extends BaseController {
    ...
    public String uIndex(Model model, Item item,HttpServletRequest request){
        ...
        //折扣商品
        List<Item> zks = itemService.listBySqlReturnEntity("select * from item where isDelete=0 and zk<9 and zk is not null order by zk desc limit 0,20");
        model.addAttribute("zks",zks);

        //热销商品
        List<Item> rxs = itemService.listBySqlReturnEntity("select * from item where isDelete=0 order by gmNum desc limit 0,15");
