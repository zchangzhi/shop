...
<div class="width100" style="height: 25px;background: #f0f0f0;">
    <div class="width1200 center_yh font14 c_66" style="height: 25px;line-height: 25px;">
        <font class="left_yh">欢迎来到网上超市！</font>
...
<div class="width1200 hidden_yh">
    <div class="center_yh hidden_yh" style="width: 500px;margin-left: 200px;">
        <a href="${ctx}/login/uIndex" class="block_yh left_yh">
            <img src="${ctx}/resource/images/logo3.png" alt="" style="height: 70px">
        </a>
    </div>
        <div class="right_yh" style="height:28px;width:316px;border:2px solid #d3d3d3;margin-top:-40px;">
